...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <header class="header">
        <div class="container">
            ...
            <div class="header-content">
                <h4 class="header-subtitle" >Salut a tous, Je suis</h4>
                <h1 class="header-title">SAM le DEV</h1>
                <h6 class="header-mono" >Développeur Web, Mobile & Robotique</h6>
                <a class="btn btn-primary btn-rounded" href="assets/CV/CV_SAMIE.pdf"><i class="ti-printer pr-2"></i>voir mon CV</a>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a href="#resume" class="nav-link">Mon Parcours</a>
                    </li>
                </ul>
                <ul class="navbar-nav brand">
                    <img src="assets/imgs/avatar.png" alt="" class="brand-img">
                    <li class="brand-txt">
                        <h5 class="brand-title">SAM le DEV</h5>
                        <div class="brand-subtitle">Développeur Web, Mobile & Robotique</div>
                    </li>
                </ul>
    ...
    <div class="container-fluid">
        <div id="about" class="row about-section">
            <div class="col-lg-4 about-card">
                ...
                <h5 class="mb-3">Un Web Designer / Developeur du Togo</h5>
                ...
                <a class="btn btn-outline-danger" href="assets/CV/CV_SAMIE.pdf"><i class="icon-down-circled2 "></i>Telecharger mon CV</a>
            </div>
            <div class="col-lg-4 about-card">
                <h3 class="font-weight-light">Information personel</h3>
                <span class="line mb-5"></span>
                <ul class="mt40 info list-unstyled">
                    <li><span>Date de naissance</span> : 05/12/2005</li>
                    <li><span>Email</span> : <a href="mailto:samledev@gmail.com" style="color: rgb(99, 103, 107);">samledev@gmail.com</a></li>
                    <li><span>Phone</span> : <a href="tel:+22893112060" style="color: rgb(99, 103, 107);">+(228) 93 11 20 60</a></li>
                    <li><span>Skype</span> : samledev </li>
    ...
    <section class="section" id="resume">
        <div class="container">
            <h2 class="mb-5"><span class="text-danger">My</span> Parcours</h2>
            <div class="row">
    ...
    <?php
        $select = mysqli_query($db, "SELECT * FROM `projects`") or die('Query failed');
    ...
    <section class="section" id="blog">
        <div class="container">
            <h2 class="mb-5"><span class="text-danger">Mes</span> Projets</h2>
            <div class="row">
                ...
                <?php
                    ...
                    for ($i=3; $i < 5; $i++) { 
                        ...
                        $select = mysqli_query($db, "SELECT * FROM `projects` WHERE id = $i") or die('Query failed');
                        if (mysqli_num_rows($select) > 0) {
                            $fetch = mysqli_fetch_assoc($select);
                            // echo $fetch['Description'];
                        }
                    ...
                    <div class="blog-card">
                        ...
                        <?php echo '<img src="assets/imgs/projects/'.$fetch['image'].'" alt="profile">'; ?>
                        
                        <!-- <img src="assets/imgs/projects/logo12_14_205245.png" alt=""> -->
                        </div>
                        <div class="content-holder">
                            <h6 class="title"><?php echo htmlspecialchars($fetch['name']); ?></h6>
                            <br>                       
                            <p><?php echo htmlspecialchars($fetch['Description']); ?></p>

                            <a href="<?php echo htmlspecialchars($fetch['link']); ?>" class="read-more">voir plus <i class="ti-angle-double-right"></i></a>
                        </div>
                    </div> 
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="contact-form-card">
                        <h4 class="contact-title">Me laisser un message</h4>
                        <form action="">
                ...
                <div class="col-lg-4">
                    <div class="contact-info-card">
                        <h4 class="contact-title">Mes contacts</h4>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                                <i class="ti-mobile icon-md"></i>
                            </div>
                            <div class="col-10 ">
                                <h6 class="d-inline">Tel : <br> <span class="text-muted"><a href="tel:+22893112060" style="color: rgb(99, 103, 107);">+(228) 93 11 20 60</a></span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Address :<br> <span class="text-muted">12345 Fake ST NoWhere.</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Email :<br> <span class="text-muted"><a href="mailto:samledev@gmail.com" style="color: rgb(99, 103, 107);">samledev@gmail.com</a></span></h6>
                            </div>
                        </div>
    ...
    <footer class="footer py-3">
        <div class="container">
            <p class="small mb-0 text-light">
                &copy; <script>document.write(new Date().getFullYear())</script> Created <i class="ti-heart text-danger"></i> By <a href="#" target="_blank"><span class="text-danger" title="Bootstrap 4 Themes and Dashboards">SAM le DEV</span></a> 
            </p>
        </div>
    </footer>
