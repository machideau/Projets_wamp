  ...
  <div class="update-profile">
    ...
    <div class="flex">
        <div class="inputBox">
            ...
            <input type="text" name="nom_update" placeholder="Enter le nom du produit à modifier" class="box">
        </div>
        <input type="submit" name="valider" value="modifier" class="btn">
