<?php
  ...
  include 'php/db.php';
  // inclure le fichier d'envoie de message 
  include 'php/message.php';
  // inclure le fichier de recuperation de l'email de l'utilisateur
  include 'php/get-email.php';
?>
              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="detail-box">
                    <h1>
                      Meilleurs et jolis plats <br>
                      <span>
                        Notre responsabilité
                      </span>
                    </h1>
                    <p>
                      Notre mission est de fournir des assiettes qui combinent beauté et fonctionnalité pour chaque occasion.
                      Nous nous efforçons de rendre chaque repas spécial avec des produits qui ajoutent une touche de sophistication à votre table.
                    </p>
                    <div class="btn-box">
      ...
      <div class="row">
        ...
        <div class="col-md-6 px-0">
          <div class="detail-box">
            ...
            <p>
              Fondée en 2024 par Pablo, EPI_STORE a commencé avec une simple idée : 
              vendre des assiettes de haute qualité à des prix abordables. <br>
              Depuis, nous avons évolué pour devenir un leader dans le domaine des ustensiles de table.
            </p>
            <div class="btn-box">
              <a href="">
                voir plus
  ...
  <section class="team_section layout_padding">
    <div class="container">
      <div class="heading_container heading_center">
        ...
        <p>
          Chaque produit que nous offrons est soigneusement inspecté pour garantir qu'il respecte nos normes strictes de qualité. 
          Nous croyons que chaque détail compte et nous nous engageons à vous fournir le meilleur.
        </p>
      </div>
      <div class="row">
        <?php
          // afficher la liste des produits
          $req = mysqli_query($db, "SELECT * FROM produits ORDER BY RAND() LIMIT 3");
          while($row = mysqli_fetch_assoc($req)){
            // $rrow = $row['id_produits'];
            // for ($rrow = 1;$rrow <= 3 ;$rrow++) { 
        ...
        <div class="col-md-4 col-sm-6 mx-auto ">
          <div class="box">
            <div class="img-box">
              <a href="admin/produit-images/<?=$row['image']?>"><img src="admin/produit-images/<?=$row['image']?>" alt="produit"></a>
            </div>
            <div class="detail-box">
              <h5>
                <?=$row['nom']?>
            ...
            <form action="" method="post">
              <div class="contact_form-container">
                <div>
                  ...
                  <div>
                    <input type="number" placeholder="Numero de téléphone" name="num_tel" required>
                  </div>
                  <div class="">
                    <input type="text" placeholder="Votre message" class="message_input" name="message" required>
                  </div>
                  <div class="btn-box ">
